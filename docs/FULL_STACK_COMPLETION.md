...
| Integration, Docker, migration rehearsal                                 | PARTIAL        | A deterministic pre-Second-Pass upgrade rehearsal is available through `npm run test:migrations:upgrade`; it requires a dedicated PostgreSQL scratch database. Full Docker/start evidence remains pending. |
