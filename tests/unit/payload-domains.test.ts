...
describe('Payload domain registration', () => {
  it('registers every existing collection, global, and task exactly once', () => {
    ...
    expect(registrations.globals.map(({ slug }) => slug)).toEqual(['site-settings'])
