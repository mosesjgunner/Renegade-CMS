module.exports=[235492,e=>{"use strict";var i=e.i(518899);async function t({db:e}){await e.execute(i.sql`
  ...
  `)}async function y({db:e}){await e.execute(i.sql`DROP TABLE IF EXISTS "donation_events"; DROP TABLE IF EXISTS "donations"; DROP TABLE IF EXISTS "donation_intents"; DROP TABLE IF EXISTS "donation_campaigns";`)}async function k({db:e}){await e.execute(i.sql`
  ...
  `)}async function W({db:e}){await e.execute(i.sql`ALTER TABLE "contacts" DROP COLUMN IF EXISTS "phone_e164"; ALTER TABLE "subscribers" DROP COLUMN IF EXISTS "erased_at";`)}async function V({db:e}){await e.execute(i.sql`
  ...
  `)}async function J({db:e}){await e.execute(i.sql`DROP TABLE IF EXISTS "email_templates";`)}async function ee({db:e}){await e.execute(i.sql`
  ...
  `)}async function ei({db:e}){await e.execute(i.sql`DROP TABLE IF EXISTS "email_delivery_events";`)}async function et({db:e}){await e.execute(i.sql`
  ...
  `)}async function e_({db:e}){await e.execute(i.sql`
...
`)}async function ej({db:e}){await e.execute(i.sql`DROP TABLE IF EXISTS "message_attachments";`)}async function eK({db:e}){await e.execute(i.sql`
  ...
  `)}async function e8({db:e}){await e.execute(i.sql`ALTER TABLE page_layouts DROP COLUMN IF EXISTS published_presentation;`)}async function e4({db:e}){await e.execute(i.sql`
  ...
  `)}async function ii({db:e}){await e.execute(i.sql`DROP TABLE IF EXISTS presentation_theme_previews, presentation_theme_audit, presentation_theme_state;`)}async function it({db:e}){await e.execute(i.sql`ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "theme_id" varchar DEFAULT 'neutral-starter';`)}async function i_({db:e}){await e.execute(i.sql`ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "theme_id";`)}async function iE({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  CREATE INDEX "payload_migrations_created_at_idx" ON "payload_migrations" USING btree ("created_at");`)}async function is({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  DROP TYPE "public"."enum_sites_lifecycle";`)}async function ia({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  CREATE INDEX "payload_jobs_created_at_idx" ON "payload_jobs" USING btree ("created_at");`)}async function id({db:e,payload:t,req:_}){await e.execute(i.sql`
   DROP TABLE "payload_jobs_log" CASCADE;
  DROP TABLE "payload_jobs" CASCADE;
  DROP TABLE "payload_jobs_stats" CASCADE;
  DROP TYPE "public"."enum_payload_jobs_log_task_slug";
  DROP TYPE "public"."enum_payload_jobs_log_state";
  DROP TYPE "public"."enum_payload_jobs_task_slug";`)}async function io({db:e}){await e.execute(i.sql`
    ...
    CREATE INDEX "recovery_codes_user_id_idx" ON "recovery_codes" USING btree ("user_id");`)}async function ir({db:e}){await e.execute(i.sql`
    ...
    DROP TYPE "public"."enum_users_role";`)}async function iN({db:e}){await e.execute(i.sql`
    ALTER TABLE "installation_state" ADD COLUMN "registration_session_hash" varchar;`)}async function ic({db:e}){await e.execute(i.sql`
    ALTER TABLE "installation_state" DROP COLUMN "registration_session_hash";`)}async function iT({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  `)}async function iL(e){throw Error("Refusing to roll back event_timeline_reconciliation automatically: the migration is additive, but safe rollback requires a reviewed plan for seeded Event/Timeline data and retained relation records.")}async function iA({db:e}){await e.execute(i.sql`
  ...
  `)}async function ip({db:e}){await e.execute(i.sql`DROP TABLE IF EXISTS "site_settings";`)}let iO=["content","events","timelines"];async function im({db:e}){for(let t of iO)await e.execute(i.sql.raw(`
      DO $$
      BEGIN
        IF EXISTS (
          SELECT 1 FROM information_schema.columns
        ...
        END IF;
      END $$;
    `))}async function iR({db:e}){for(let t of iO)await e.execute(i.sql.raw(`
      DO $$
      BEGIN
        IF EXISTS (
          SELECT 1 FROM information_schema.columns
        ...
        END IF;
      END $$;
    `))}async function iD({db:e}){await e.execute(i.sql`
    DO $$ BEGIN
  ...
  `)}async function iI(e){throw Error("20260818_062327_m04_c_editorial_workflow is additive and owned by editorial.m04; rollback requires reviewed manual data migration.")}async function iU({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  CREATE INDEX "payload_locked_documents_rels_page_layouts_id_idx" ON "payload_locked_documents_rels" USING btree ("page_layouts_id");`)}async function iS({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  DROP TYPE "public"."enum_page_layouts_retention_hold";`)}async function ib({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  CREATE INDEX "payload_locked_documents_rels_identity_audit_events_id_idx" ON "payload_locked_documents_rels" USING btree ("identity_audit_events_id");`)}async function iC({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  DROP TYPE "public"."enum_identity_tokens_purpose";`)}async function iF({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  CREATE INDEX "payload_locked_documents_rels_quick_capture_drafts_id_idx" ON "payload_locked_documents_rels" USING btree ("quick_capture_drafts_id");`)}async function ih({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  DROP TYPE "public"."enum_quick_capture_drafts_offline_state";`)}async function iv({db:e,payload:t,req:_}){await e.execute(i.sql`
   ALTER TABLE "videos" ADD COLUMN "provider_identity" varchar NOT NULL;
  CREATE UNIQUE INDEX "videos_provider_identity_idx" ON "videos" USING btree ("provider_identity");`)}async function iy({db:e,payload:t,req:_}){await e.execute(i.sql`
   DROP INDEX "videos_provider_identity_idx";
  ALTER TABLE "videos" DROP COLUMN "provider_identity";`)}async function ik({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  CREATE INDEX "payload_locked_documents_rels_calendar_entry_audits_id_idx" ON "payload_locked_documents_rels" USING btree ("calendar_entry_audits_id");`)}async function iX({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  DROP TYPE "public"."enum_campaigns_status";`)}async function iP({db:e}){await e.execute(i.sql`
  ...
  `)}async function iw({db:e}){await e.execute(i.sql`
  ...
  `)}async function iB({db:e,payload:t,req:_}){await e.execute(i.sql`
   DO $$ BEGIN
    CREATE TYPE "public"."enum_media_assets_rights_status" AS ENUM('pending', 'approved', 'restricted', 'expired');
  EXCEPTION
    WHEN duplicate_object THEN null;
  ...
  CREATE INDEX "payload_locked_documents_rels_entitlements_id_idx" ON "payload_locked_documents_rels" USING btree ("entitlements_id");`)}async function ig({db:e,payload:t,req:_}){await e.execute(i.sql`
  ...
  DROP TYPE "public"."enum_supporters_visibility_preference";`)}async function ix({db:e}){await e.execute(i.sql`
  ...
  `)}async function iG(e){throw Error("20260829_110000_content_release_execution is additive; rollback requires a reviewed data migration.")}async function iY({db:e}){await e.execute(i.sql`
  ...
  `)}async function iM(e){throw Error("20260829_120000_quality_runtime is additive; rollback requires a reviewed data migration.")}async function ij({db:e}){await e.execute(i.sql`
    ALTER TABLE "site_settings"
  ...
  `)}async function iK({db:e}){await e.execute(i.sql`
    ALTER TABLE "site_settings"
  ...
  `)}async function i$({db:e}){await e.execute(i.sql`
    ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "onboarding_primary_url" varchar,
      ...
      ADD COLUMN IF NOT EXISTS "onboarding_starter_content" boolean DEFAULT true;`)}async function iz({db:e}){await e.execute(i.sql`ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "onboarding_primary_url", DROP COLUMN IF EXISTS "onboarding_locale", DROP COLUMN IF EXISTS "onboarding_timezone", DROP COLUMN IF EXISTS "onboarding_feature_profile", DROP COLUMN IF EXISTS "onboarding_starter_type", DROP COLUMN IF EXISTS "onboarding_starter_content";`)}async function iq({db:e}){await e.execute(`
  ...
  `)}async function iH({db:e}){await e.execute(`
  ...
  `)}async function iW({db:e}){await e.execute(`
  ...
  `)}async function iV(e){}async function iQ({db:e}){await e.execute(`
  ...
  `)}async function iZ({db:e}){await e.execute(`
  ...
  `)}async function iJ({db:e}){await e.execute(`
  ...
  `)}async function i7({db:e}){await e.execute('DROP TABLE IF EXISTS "public_redirects" CASCADE; DROP TYPE IF EXISTS "public"."enum_public_redirects_match"; DROP TYPE IF EXISTS "public"."enum_public_redirects_status_code";')}async function i8({db:e}){await e.execute(`
  ...
  `)}async function te({db:e}){await e.execute(i.sql`
  ...
  `)}async function ti({db:e}){await e.execute(i.sql`
  ...
  `)}async function tt({db:e}){await e.execute(i.sql`
  ...
  `)}async function t_({db:e}){await e.execute(i.sql`
  ...
  `)}async function tE(e){throw Error("20260831_090000_phase_b_execution_foundation is additive; rollback requires a reviewed data migration.")}async function ts({db:e}){await e.execute(i.sql`
  ...
  `)}async function ta(e){throw Error("Analytics privacy records are immutable audit evidence; use a reviewed retention migration.")}async function td({db:e}){await e.execute(`
    ALTER TABLE "events"
  ...
  `)}async function to({db:e}){await e.execute('DROP TABLE IF EXISTS "events_rels" CASCADE; ALTER TABLE "events" DROP COLUMN IF EXISTS "venue_address", DROP COLUMN IF EXISTS "online_url", DROP COLUMN IF EXISTS "organizer_name", DROP COLUMN IF EXISTS "organizer_url", DROP COLUMN IF EXISTS "capacity", DROP COLUMN IF EXISTS "registration_url", DROP COLUMN IF EXISTS "recurrence", DROP COLUMN IF EXISTS "recurrence_overrides";')}async function tn({db:e}){await e.execute(`
  ...
  `)}async function tr({db:e}){await e.execute(`
  ...
  `)}async function tc(e){throw Error("20260831_130000_books_quality_center is additive; rollback requires a reviewed data migration.")}async function tT({db:e}){await e.execute(i.sql`
  ...
  `)}async function tu(e){throw Error("20260831_140000_public_api_webhooks is additive; rollback requires a reviewed data migration.")}async function tl({db:e}){await e.execute(i.sql`
    ALTER TABLE "payload_locked_documents_rels" ADD COLUMN IF NOT EXISTS "execution_events_id" uuid;
    DO $$ BEGIN ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_execution_events_fk" FOREIGN KEY ("execution_events_id") REFERENCES "execution_events"("id") ON DELETE CASCADE; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
    CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_execution_events_id_idx" ON "payload_locked_documents_rels" ("execution_events_id");
    ALTER TABLE "payload_locked_documents_rels" ADD COLUMN IF NOT EXISTS "analytics_consent_records_id" uuid;
    DO $$ BEGIN ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_analytics_consent_records_fk" FOREIGN KEY ("analytics_consent_records_id") REFERENCES "analytics_consent_records"("id") ON DELETE CASCADE; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
    CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_analytics_consent_records_id_idx" ON "payload_locked_documents_rels" ("analytics_consent_records_id");
  `)}async function tL(e){throw Error("Phase B lock relations are additive; rollback requires a reviewed data migration.")}async function tA({db:e}){await e.execute(i.sql`
    ALTER TABLE "books" ADD COLUMN IF NOT EXISTS "description" varchar;
    ALTER TABLE "books" ADD COLUMN IF NOT EXISTS "status" varchar DEFAULT 'draft' NOT NULL;
    ALTER TABLE "books" ADD COLUMN IF NOT EXISTS "published_at" timestamp(3) with time zone;
  `)}async function tp(e){throw Error("Phase B book lifecycle fields are additive; rollback requires a reviewed data migration.")}async function tO({db:e}){await e.execute(i.sql`
    ALTER TABLE "video_channels" ADD COLUMN IF NOT EXISTS "description" varchar;
    ALTER TABLE "video_channels" ADD COLUMN IF NOT EXISTS "status" varchar DEFAULT 'draft';
    ALTER TABLE "video_channels" ADD COLUMN IF NOT EXISTS "published_at" timestamp(3) with time zone;
    ALTER TABLE "video_playlists" ADD COLUMN IF NOT EXISTS "description" varchar;
    ...
    ALTER TABLE "livestreams" ADD COLUMN IF NOT EXISTS "status" varchar DEFAULT 'draft';
    ALTER TABLE "livestreams" ADD COLUMN IF NOT EXISTS "published_at" timestamp(3) with time zone;
  `)}async function tm(e){throw Error("Phase B media lifecycle fields are additive; rollback requires a reviewed data migration.")}async function tR({db:e}){await e.execute(i.sql`
    CREATE TABLE IF NOT EXISTS "videos_rels" (
      "id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
      "order" integer,
      "parent_id" uuid NOT NULL REFERENCES "videos"("id") ON DELETE cascade,
    ...
    CREATE INDEX IF NOT EXISTS "videos_rels_parent_idx" ON "videos_rels" ("parent_id");
    CREATE INDEX IF NOT EXISTS "videos_rels_media_assets_idx" ON "videos_rels" ("media_assets_id");
  `)}async function tD(e){throw Error("Phase B video captions relation is additive; rollback requires a reviewed data migration.")}async function tI({db:e}){await e.execute(i.sql`
  ...
  `)}async function tU(e){throw Error("Phase B integrations defaults are additive; rollback requires a reviewed data migration.")}async function tS({db:e}){await e.execute(i.sql`
    ...
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
  `)}async function tb(e){throw Error("PUB-02 migrates canonical bodies; rollback requires a reviewed export.")}async function tC({db:e}){await e.execute(i.sql`
  ...
  `)}async function tF(e){throw Error("PUB-01 establishes tenant ownership; restore from a reviewed backup to roll back.")}async function th({db:e}){await e.execute(i.sql`
  ...
  `)}async function tv({db:e}){await e.execute(i.sql`
  ...
  `)}e.s(["migrations",0,[{up:iE,down:is,name:"20260812_010209_initial_foundation"},{up:ia,down:id,name:"20260812_034055_m02_operations_jobs"},{up:io,down:ir,name:"20260812_080000_m02_first_run_installation"},{up:iN,down:ic,name:"20260812_081000_m02_single_use_setup_token"},{up:iT,down:iu,name:"20260813_054441_canonical_information_architecture"},{up:il,down:iL,name:"20260814_120000_m03_5_event_timeline_reconciliation"},{up:iA,down:ip,name:"20260818_000000_site_settings"},{up:im,down:iR,name:"20260818_010000_reconcile_seo_canonical_columns"},{up:iD,down:iI,name:"20260818_062327_m04_c_editorial_workflow"},{up:iU,down:iS,name:"20260822_010232_page_layouts"},{up:ib,down:iC,name:"20260822_012313_m07_a_passwordless_identity"},{up:iF,down:ih,name:"20260825_171336"},{up:iv,down:iy,name:"20260825_171738"},{up:ik,down:iX,name:"20260825_173116_social_distribution"},{up:iP,down:iw,name:"20260825_180000_calendar_graphics"},{up:iB,down:ig,name:"20260826_053416_second_pass_schema"},{up:ix,down:iG,name:"20260829_110000_content_release_execution"},{up:iY,down:iM,name:"20260829_120000_quality_runtime"},{up:ij,down:iK,name:"20260829_130000_progressive_disclosure_admin"},{up:i$,down:iz,name:"20260829_140000_onboarding_settings"},{up:iq,down:iH,name:"20260829_150000_integrations"},{up:iW,down:iV,name:"20260829_160000_activitypub_delivery"},{up:iQ,down:iZ,name:"20260829_170000_network_experience"},{up:iJ,down:i0,name:"20260829_180000_collaboration"},{up:i3,down:i2,name:"20260830_090000_realtime_collaboration"},{up:i1,down:i6,name:"20260830_100000_media_storage_workflow"},{up:i9,down:i7,name:"20260830_110000_discoverability"},{up:i8,down:i4,name:"20260830_120000_discoverability_lock_relation"},{up:i5,down:te,name:"20260830_130000_admin_auth_hardening"},{up:t_,down:tE,name:"20260831_090000_phase_b_execution_foundation"},{up:ts,down:ta,name:"20260831_100000_analytics_privacy_runtime"},{up:td,down:to,name:"20260831_110000_events_workflow"},{up:tn,down:tr,name:"20260831_120000_media_publishing_workflows"},{up:tN,down:tc,name:"20260831_130000_books_quality_center"},{up:tT,down:tu,name:"20260831_140000_public_api_webhooks"},{up:tl,down:tL,name:"20260831_150000_phase_b_locked_document_relations"},{up:tA,down:tp,name:"20260831_160000_phase_b_book_lifecycle_reconciliation"},{up:tO,down:tm,name:"20260831_170000_phase_b_scoped_media_reconciliation"},{up:tR,down:tD,name:"20260831_180000_phase_b_video_captions_relation"},{up:tI,down:tU,name:"20260831_190000_phase_b_integrations_id_defaults"},{up:ti,down:tt,name:"20260831_200000_member_identity_foundation"},{up:tS,down:tb,name:"20260902_000000_pub_02_content_publishing_pass"},{up:tC,down:tF,name:"20260902_010000_pub_01_canonical_tenant_isolation"},{up:th,down:tv,name:"20260902_020000_pub_04_publishing_floor"},{up:it,down:i_,name:"20260912_000000_pre_00_theme_selection"},{up:ie,down:ii,name:"20260912_010000_pre_01_theme_lifecycle"},{up:e7,down:e8,name:"20260912_020000_pre_01_presentation_snapshots"},{up:e4,down:e5,name:"20260912_030000_pre_03_visual_editor"},{up:e6,down:e9,name:"20260912_040000_pre_04_reusable_composition"},{up:t,down:_,name:"20260912_050000_pre_05_legacy_site_migration"},{up:E,down:s,name:"20260912_060000_med_00_media_contract"},{up:a,down:d,name:"20260912_070000_med_01_upload_sessions"},{up:o,down:n,name:"20260913_080000_med_02_dam_governance"},{up:r,down:N,name:"20260913_090000_med_03_image_variants"},{up:c,down:T,name:"20260913_100000_med_04_podcast_workflow"},{up:u,down:l,name:"20260914_110000_med_05_video_workflow"},{up:L,down:A,name:"20260914_120000_disc_01_discovery_workflow"},{up:p,down:O,name:"20260914_121000_disc_01_shared_seo_fields"},{up:m,down:R,name:"20260915_130000_disc_04_search_projection"},{up:D,down:I,name:"20260916_070000_editorial_quality_gate_snapshot"},{up:U,down:S,name:"20260920_000000_aud_00_delivery_snapshots"},{up:H,down:W,name:"20260920_010000_aud_01_audience_evidence"},{up:V,down:Q,name:"20260920_020000_aud_02_forms"},{up:Z,down:J,name:"20260920_030000_aud_03_email_composer"},{up:ee,down:ei,name:"20260920_050000_aud_05_email_delivery"},{up:et,down:e_,name:"20260920_060000_aud_06_telecom"},{up:eE,down:es,name:"20260920_070000_aud_07_audience_command"},{up:ea,down:ed,name:"20260920_080000_aud_08_audience_pass_gate"},{up:eo,down:en,name:"20260920_090000_comm_00_community_domain"},{up:er,down:eN,name:"20260920_100000_comm_01_member_auth_lifecycle"},{up:ec,down:eT,name:"20260921_000000_comm_02_profile_projection"},{up:eu,down:el,name:"20260921_010000_comm_02_profile_media_usage_relation"},{up:eL,down:eA,name:"20260921_020000_comm_03a_comment_identity"},{up:ep,down:eO,name:"20260921_030000_comm_03c_comment_reactions"},{up:em,down:eR,name:"20260921_040000_comm_03d_thread_lifecycle_and_outbox"},{up:eD,down:eI,name:"20260921_050000_comm_04a_forum_spaces"},{up:eU,down:eS,name:"20260922_000000_comm_04b_forum_topics_posts"},{up:eb,down:eC,name:"20260922_010000_comm_04c_forum_browsing_read_state"},{up:eF,down:eh,name:"20260922_020000_comm_04d_forum_topic_operations"},{up:ev,down:ey,name:"20260922_030000_comm_05a_moderation_registry_reports"},{up:ek,down:eX,name:"20260922_040000_comm_05b_moderation_actions_sanctions"},{up:ef,down:eP,name:"20260922_050000_comm_05c_moderation_appeals_audit"},{up:ew,down:eB,name:"20260922_060000_comm_05d_abuse_triage_console"},{up:eg,down:ex,name:"20260922_070000_comm_07a_conversations"},{up:eG,down:eY,name:"20260922_080000_comm_07b_message_requests"},{up:eM,down:ej,name:"20260922_090000_comm_07c_message_attachments"},{up:eK,down:e$,name:"20260922_100000_comm_07d_group_administration"},{up:ez,down:eq,name:"20260922_110000_comm_06b_inbox_projections"},{up:eH,down:eW,name:"20260922_120000_comm_06c_notification_preferences_and_outbox"},{up:eV,down:eQ,name:"20260922_130000_commerce_canonical_contract"},{up:eZ,down:eJ,name:"20260923_010000_shop_01_catalog_workflows"},{up:e0,down:e3,name:"20260923_020000_shop_02_carts_and_checkout_proposals"},{up:e2,down:e1,name:"20260923_030000_shop_04_payment_operations"},{up:b,down:C,name:"20260923_040000_shop_05_subscriptions"},{up:F,down:h,name:"20260923_050000_shop_06_affiliate_and_referrals"},{up:v,down:y,name:"20260923_060000_shop_07_donations"},{up:k,down:X,name:"20260923_070000_shop_07_donation_lifecycle"},{up:f,down:P,name:"20260923_080000_shop_03_pod_and_fulfillment"},{up:w,down:B,name:"20260923_090000_events_required_entitlement"},{up:g,down:x,name:"20260923_100000_flow_03_scheduler_runtime"},{up:G,down:Y,name:"20260923_110000_content_release_runtime"},{up:M,down:j,name:"20260924_000000_collection_scope_columns"},{up:K,down:$,name:"20260924_010000_donation_checkout_idempotency"},{up:z,down:q,name:"20260924_020000_commerce_job_enum"}]],235492)}];
